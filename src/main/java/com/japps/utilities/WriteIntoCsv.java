...
public class WriteIntoCsv {
	...
	public void CreateCSVFileForCaseDetails() throws IOException, Exception {
		...
		csvFileNaME = new File(
				currentDirectory + File.separator + currentDATEANDTIME + File.separator + "CASE_DETAILS");
		csvFileNaME.mkdirs();
		csvFileNaME = new File(currentDirectory + File.separator + currentDATEANDTIME + File.separator + "CASE_DETAILS"
				+ File.separator + "CASEDETAILS_07_" + fullCurrentTimeStamp + ".csv");
	...
	public void CaseDetails() throws Exception {
		System.out.println(" CaseDetails() Fetching START TIME >>"
		...
		if (!Name.equals("")) {
			...
			if (Middle_Name.equals("JR") || Middle_Name.equals("SR") || Middle_Name.equals("I")
					|| Middle_Name.equals("II") || Middle_Name.equals("III") || Middle_Name.equals("JR.")
					|| Middle_Name.equals("SR.") || Middle_Name.equals("IV") || Middle_Name.equals("V")
					|| Middle_Name.equals("VI") || Middle_Name.equals("VII") || Middle_Name.equals("VIII")
					|| Middle_Name.equals("IX") || Middle_Name.equals("X")) {
				if (Middle_Name.equals("JR") && suffix.isEmpty() || Middle_Name.equals("JR.") && suffix.isEmpty()) {
					Middle_Name = "Jr.";
					Last_Name = Last_Name + " " + Middle_Name;
					Middle_Name = "";
				} else if (Middle_Name.equals("SR") && suffix.isEmpty()
						|| Middle_Name.equals("SR.") && suffix.isEmpty()) {
					Middle_Name = "Sr.";
					Last_Name = Last_Name + " " + Middle_Name;
					Middle_Name = "";
				} else if (Middle_Name.equals("I") || Middle_Name.equals("II") || Middle_Name.equals("III")
						|| Middle_Name.equals("IV") || Middle_Name.equals("V") || Middle_Name.equals("VI")
						|| Middle_Name.equals("VII") || Middle_Name.equals("VIII") || Middle_Name.equals("IX")
						|| Middle_Name.equals("X")) {
					Last_Name = Last_Name + " " + Middle_Name;
					Middle_Name = "";
				}
				...
				if (suffix.equals("JR") || suffix.equals("JR.")) {
					...
					suffix = "Sr.";
					Last_Name = Last_Name + " " + suffix;
				} else if (suffix.equals("I") || suffix.equals("II") || suffix.equals("III") || suffix.equals("IV")
						|| suffix.equals("V") || suffix.equals("VI") || suffix.equals("VII") || suffix.equals("VIII")
						|| suffix.equals("IX") || suffix.equals("X")) {
					Last_Name = Last_Name + " " + suffix;
		...
		System.out.println(" CaseDetails() Fetching END TIME >>"
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new Date(System.currentTimeMillis())));
		System.out.println(" CaseDetails() Fetching END TIME >>"
				+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new Date(System.currentTimeMillis())));
		System.out.println("###############");
